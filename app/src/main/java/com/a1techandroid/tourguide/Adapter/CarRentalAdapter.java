...
import com.a1techandroid.tourguide.CarRentalActivity;
...
public class CarRentalAdapter extends BaseAdapter {
    ...
    public CarRentalAdapter(Context context, ArrayList<CarRentalModel> list) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null){
            ...
            convertView = mInflater.inflate(R.layout.car_rental_item, null);
        ...
        final CarRentalModel name = list.get(position);
        ...
        convertView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(v.getContext(), CarRentalActivity.class);
                Gson gson = new Gson();
